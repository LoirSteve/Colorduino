/*
  ...
  Modified to show on two Colorduinos
This works!
...
#define LEFT_I2C_ADDR 15        //set destination I2C address 
#define RIGHT_I2C_ADDR 16          //set destination I2C address 

#define SCREENSIZEX 8            //num of LEDs accross
#define SCREENSIZEY 8            //num of LEDs down

byte display_byte[3][128];      //display array - 64 bytes x 3 colours 
...
unsigned char plasma[SCREENSIZEX][16];
long paletteShift;
...
for(x = 0; x <SCREENSIZEX; x++) {
	...
	display(x, y-8, colorRGB.r, colorRGB.g, colorRGB.b);
      }
  }

 update_display(RIGHT_I2C_ADDR);
paletteShift++;
}
