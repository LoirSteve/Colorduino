/*Modified 19/4/2014
  And it does not produce errors!
  Set board as Duemilanove
...
#define I2C_DEVICE_ADDRESS 1  //I2C address for this device 
...
void setup()
{
  ...
  // whiteBalVal[1]=green
  // whiteBalVal[2]=blue
  unsigned char whiteBalVal[3] = {28,63,63}; // for LEDSEE 6x6cm round matrix
